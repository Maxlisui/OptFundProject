...
public class AntConstants {
    ...
    public static final String ALPHA_CONSTANT = "alpha";
    ...
    public static final String POPULATION_SIZE_CONSTANT = "populationSize";
    public static final String OFF_SIZE_CONSTANT = "offSize";
